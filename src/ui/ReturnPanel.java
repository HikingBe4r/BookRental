...
public class ReturnPanel extends JPanel implements ActionListener {
	...
	class ButtonRenderer extends JButton implements TableCellRenderer {
		...
		public Component getTableCellRendererComponent(JTable retrievetable, Object value, boolean isSelected,
	...
	class ButtonRenderer01 extends JButton implements TableCellRenderer {
		...
		public Component getTableCellRendererComponent(JTable renewalcarttable, Object value, boolean isSelected,
				boolean hasFocus, int row, int column) {
			if (isSelected) {
	...
	class ButtonEditor01 extends DefaultCellEditor {
		...
		public Object getCellEditorValue() {
			...
			if (isPushed) { // 연장 취소버튼
				...
				renewalbooks.remove(index); // 장바구니에 담긴 순서와 테이블에 표시되는 순서가 같으므로
											// 인덱스로 삭제 가능
	...
	class ButtonRenderer02 extends JButton implements TableCellRenderer {
		...
		public Component getTableCellRendererComponent(JTable returncarttable, Object value, boolean isSelected,
				boolean hasFocus, int row, int column) {
			if (isSelected) {
	...
	DefaultTableCellRenderer dcr02 = new DefaultTableCellRenderer() {
		public Component getTableCellRendererComponent(JTable rentalcarttable, Object value, boolean isSelected,
				boolean hasFocus, int row, int column) {
			JCheckBox box = new JCheckBox();
			box.setSelected(((Boolean) value).booleanValue());
			box.setHorizontalAlignment(JLabel.CENTER);
	...
	class ButtonEditor02 extends DefaultCellEditor {
		...
		public Object getCellEditorValue() {
			...
			if (isPushed) { // 반납 취소버튼
				...
				returnbooks.remove(index); // 장바구니에 담긴 순서와 테이블에 표시되는 순서가 같으므로
											// 인덱스로 삭제 가능
